...
using GOF23._21观察者模式.Subject;
using System;
using System.Collections.Generic;
using System.Text;

namespace GOF23._21观察者模式
{
    /// <summary>
    ...
    public class Program : OpentDesign
    {
        ...
        public override void Open()
        {
            ...
            Console.WriteLine("**************************方式二************************");
            {
                ...
                cat.AddObserver(father);
                cat.AddObserver(new Mother());
                cat.MiaoObserver();
                cat.RemoveObserver(father);//移除观察者
                cat.MiaoObserver();
            }
            Console.WriteLine("*********************方式三：委托事件*******************");
            {
                Cat cat = new Cat();
                var father = new Father();
                ...
                cat.CatMiaoEvent += father.Roar;
                cat.CatMiaoEvent += new Mother().Whisper;
                cat.MiaoEvent();
                cat.CatMiaoEvent -= father.Roar;//移除观察者
                cat.MiaoEvent();
            }
        }
    }
